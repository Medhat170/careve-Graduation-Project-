...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "clinicsProblem" : MessageLookupByLibrary.simpleMessage("لقد تم إدخال بياناتك بنجاح ولكن لم يتم إضافه عياداتك ؛سجل دخولك الان ببريدك الإلكترونى المضاف وقم بإضافتها من داخل التطبيق فى وقت لاحق"),
    ...
    "doctorHint" : MessageLookupByLibrary.simpleMessage("لا تقلقي ! الاّن يمكنك العثور على أطباء حولك والمتابعه معهم والتواصل أيضا فى أى وقت"),
