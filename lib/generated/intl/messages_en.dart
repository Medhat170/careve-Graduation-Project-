...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "armpitTumor" : MessageLookupByLibrary.simpleMessage("- Feeling of armpit tumor"),
    "article" : MessageLookupByLibrary.simpleMessage("Article"),
    "articles" : MessageLookupByLibrary.simpleMessage("Articles"),
    "articlesQuestion1" : MessageLookupByLibrary.simpleMessage("What is symptoms and causes of breast cancer ?"),
    "articlesQuestion2" : MessageLookupByLibrary.simpleMessage("How to protect yourself from breast cancer ?"),
    "articlesQuestion3" : MessageLookupByLibrary.simpleMessage("Is breast cancer a genetic disease ?"),
    "articlesQuestion4" : MessageLookupByLibrary.simpleMessage("What is breast cancer and what is the incidence of breast cancer ?"),
    "attachCV" : MessageLookupByLibrary.simpleMessage("Attach your cv or any medical approval"),
    "attachFile" : MessageLookupByLibrary.simpleMessage("Attach file"),
    "awareness" : MessageLookupByLibrary.simpleMessage("Awareness"),
    "awarenessType" : MessageLookupByLibrary.simpleMessage("Awareness type"),
    ...
    "cancelAppointment" : MessageLookupByLibrary.simpleMessage("Cancel this appointment"),
    ...
    "cost" : MessageLookupByLibrary.simpleMessage("Detection cost"),
    "cv" : MessageLookupByLibrary.simpleMessage("Cv/Medical approval"),
    "cvValidation" : MessageLookupByLibrary.simpleMessage("Cv or any medical approval is required!"),
    ...
    "firstStepSubStep1" : MessageLookupByLibrary.simpleMessage("1- Look at the breasts in the mirror with your hands in a straight position on the sides and then put your hands on the middle."),
    "firstStepSubStep2" : MessageLookupByLibrary.simpleMessage("2- Make sure you look at the shape and color of the breast size and it is the usual for you without changing or without difference."),
    "forgetPassword" : MessageLookupByLibrary.simpleMessage("forget password?"),
    "formatException" : MessageLookupByLibrary.simpleMessage("An unexpected error has occurred"),
    "forthStep" : MessageLookupByLibrary.simpleMessage("The fourth step (in the shower)"),
    "forthStepSubStep1" : MessageLookupByLibrary.simpleMessage("The previous test was re-examined in the same way as in the shower."),
    ...
    "imageValidation" : MessageLookupByLibrary.simpleMessage("Personal image is required"),
    ...
    "nullStartTime" : MessageLookupByLibrary.simpleMessage("Start time did not set"),
    ...
    "splashText1" : MessageLookupByLibrary.simpleMessage("You can find the best doctor and the nearest hospital to monitor your case"),
    "splashText2" : MessageLookupByLibrary.simpleMessage("Connect with other people who are experiencing the same things"),
    "splashText3" : MessageLookupByLibrary.simpleMessage("You can get articles and tests to check on your health"),
    "startDate" : MessageLookupByLibrary.simpleMessage("Start date"),
    "startTimeSet" : MessageLookupByLibrary.simpleMessage("Set start time"),
    "suffer" : MessageLookupByLibrary.simpleMessage("What are you suffering from?"),
    "sun" : MessageLookupByLibrary.simpleMessage("Sun"),
    "telPhone" : MessageLookupByLibrary.simpleMessage("Tel-phone"),
    "thicknessAndPain" : MessageLookupByLibrary.simpleMessage("- thickness - breast pain"),
    "thirdStep" : MessageLookupByLibrary.simpleMessage("The third step (in the bed)"),
    "thirdStepStepSubStep1" : MessageLookupByLibrary.simpleMessage("1- Lie on the bed and use the left hand to examine the right breast and right hand to examine the left breast."),
    "thirdStepStepSubStep2" : MessageLookupByLibrary.simpleMessage("2- Using your fingertips and through a circular movement, check the breast (skin and tissues)"),
    "thirdStepStepSubStep3" : MessageLookupByLibrary.simpleMessage("3- Make sure the breast is fully examined from the top to the bottom and side to side- from the collarbone to the top of your abdomen and from the armpit to the middle of the chest."),
    "thirdStepStepSubStep4" : MessageLookupByLibrary.simpleMessage("4- Until you make sure the breast is fully examined, you can start from the nipple and then move in larger and larger circles until you reach the outer area of the breast."),
    "thisEmpty" : MessageLookupByLibrary.simpleMessage("There is no data"),
    "thu" : MessageLookupByLibrary.simpleMessage("Thu"),
    "timeIsBefore" : MessageLookupByLibrary.simpleMessage("End time must be set to a time which is after the start time but not vice versa"),
    ...
    "youTubeLink" : MessageLookupByLibrary.simpleMessage("YouTube link")
  };
}
