...
class S {
  ...
  /// `لا تقلقي ! الاّن يمكنك العثور على أطباء حولك والمتابعه معهم والتواصل أيضا فى أى وقت`
  ...
  /// `لقد تم إدخال بياناتك بنجاح ولكن لم يتم إضافه عياداتك ؛سجل دخولك الان ببريدك الإلكترونى المضاف وقم بإضافتها من داخل التطبيق فى وقت لاحق`
  String get clinicsProblem {
    return Intl.message(
      'لقد تم إدخال بياناتك بنجاح ولكن لم يتم إضافه عياداتك ؛سجل دخولك الان ببريدك الإلكترونى المضاف وقم بإضافتها من داخل التطبيق فى وقت لاحق',
      name: 'clinicsProblem',
      desc: '',
